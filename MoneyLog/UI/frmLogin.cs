...
namespace MoneyLog.UI
{
    public partial class frmLogin : Form
    {
        ...
        private async void btnLogin_Click(object sender, EventArgs e)
        {
            ...
            var _firebaseAuthProvider = new FirebaseAuthProvider(new Firebase.Auth.FirebaseConfig("AIzaSyBRk19otE8Wy2IhufabyAZWYzwE7vzWa_w"));
            try
            {
                //create the user
                try
                ...
                //EmailUtil.SendEmail("Create a new user!", "Create a new user!", "yukiyuli6688@gmail.com");
